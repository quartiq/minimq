use crate::{
    ...
    de::PacketReader,
    ser::{
        ReversedPacketWriter,
        serialize::integer_size,
    },
};
...
impl<'a> Property<'a> {
    ...
    pub(crate) fn parse<'reader: 'a, T: ArrayLength<u8>>(packet: &'reader PacketReader<T>) -> Result<Property<'a>, Error> {
        ...
        match identifier {
            ...
            PropertyIdentifier::SubscriptionIdentifier => {
                Ok(Property::SubscriptionIdentifier(packet.read_variable_length_integer()?))
            },
            ...
            PropertyIdentifier::AssignedClientIdentifier => {
                Ok(Property::AssignedClientIdentifier(packet.read_utf8_string()?))
            },
            ...
            PropertyIdentifier::ReceiveMaximum => {
                Ok(Property::ReceiveMaximum(packet.read_u16()?))
            },
            PropertyIdentifier::TopicAliasMaximum => {
                Ok(Property::TopicAliasMaximum(packet.read_u16()?))
            },
            PropertyIdentifier::TopicAlias => {
                Ok(Property::TopicAlias(packet.read_u16()?))
            },
            PropertyIdentifier::MaximumQoS => {
                Ok(Property::MaximumQoS(packet.read_u8()?))
            },
            PropertyIdentifier::RetainAvailable => {
                Ok(Property::RetainAvailable(packet.read_u8()?))
            },
            PropertyIdentifier::UserProperty => {
                Ok(Property::UserProperty(packet.read_utf8_string()?, packet.read_utf8_string()?))
            },
    ...
    pub(crate) fn size(&self) -> usize {
        ...
        match self {
            ...
            Property::MessageExpiryInterval(_) | Property::SessionExpiryInterval(_) |
                Property::WillDelayInterval(_) | Property::MaximumPacketSize(_) => {
                4 + identifier_length
            },
            Property::ServerKeepAlive(_) | Property::ReceiveMaximum(_) |
                Property::TopicAliasMaximum(_) | Property::TopicAlias(_) => 2 + identifier_length,
    ...
    pub(crate) fn encode_into<'b>(&self, packet: &mut ReversedPacketWriter<'b>) -> Result<(), Error>
    {
        match self {
            Property::PayloadFormatIndicator(value) => {
                Property::encode_byte_property(packet, PropertyIdentifier::PayloadFormatIndicator, value)
            },
            Property::MessageExpiryInterval(value) => {
                Property::encode_four_byte_integer_property(packet, PropertyIdentifier::MessageExpiryInterval, value)
            },
            Property::ContentType(content_type) => {
                Property::encode_string_property(packet, PropertyIdentifier::ContentType, content_type)
            },
            ...
            Property::CorrelationData(data) => {
                Property::encode_binary_data_property(packet, PropertyIdentifier::CorrelationData, data)
            },
            Property::SubscriptionIdentifier(data) => {
                Property::encode_variable_length_integer_property(packet, PropertyIdentifier::SubscriptionIdentifier, data)
            },
            Property::SessionExpiryInterval(data) => {
                Property::encode_four_byte_integer_property(packet, PropertyIdentifier::SessionExpiryInterval, data)
            },
            Property::AssignedClientIdentifier(data) => {
                Property::encode_string_property(packet, PropertyIdentifier::AssignedClientIdentifier, data)
            },
            Property::ServerKeepAlive(data) => {
                Property::encode_two_byte_integer_property(packet, PropertyIdentifier::ServerKeepAlive, data)
            },
            Property::AuthenticationMethod(data) => {
                Property::encode_string_property(packet, PropertyIdentifier::AuthenticationMethod, data)
            },
            Property::AuthenticationData(data) => {
                Property::encode_binary_data_property(packet, PropertyIdentifier::AuthenticationData, data)
            },
            Property::RequestProblemInformation(data) => {
                Property::encode_byte_property(packet, PropertyIdentifier::RequestProblemInformation, data)
            },
            Property::WillDelayInterval(data) => {
                Property::encode_four_byte_integer_property(packet, PropertyIdentifier::WillDelayInterval, data)
            }
            Property::RequestResponseInformation(data) => {
                Property::encode_byte_property(packet, PropertyIdentifier::RequestResponseInformation, data)
            },
            Property::ResponseInformation(data) => {
                Property::encode_string_property(packet, PropertyIdentifier::ResponseInformation, data)
            },
            Property::ServerReference(data) => {
            ...
            Property::ReceiveMaximum(data) => {
                Property::encode_two_byte_integer_property(packet, PropertyIdentifier::ReceiveMaximum, data)
            },
            Property::TopicAliasMaximum(data) => {
                Property::encode_two_byte_integer_property(packet, PropertyIdentifier::TopicAliasMaximum, data)
            },
            Property::TopicAlias(data) => {
                Property::encode_two_byte_integer_property(packet, PropertyIdentifier::TopicAlias, data)
            },
            ...
            Property::UserProperty(key, value) => {
                Property::encode_string_pair_property(packet, PropertyIdentifier::UserProperty, key, value)
            },
            Property::MaximumPacketSize(data) => {
                Property::encode_four_byte_integer_property(packet, PropertyIdentifier::MaximumPacketSize, data)
            },
            Property::WildcardSubscriptionAvailable(data) => {
                Property::encode_byte_property(packet, PropertyIdentifier::WildcardSubscriptionAvailable, data)
            },
            Property::SubscriptionIdentifierAvailable(data) => {
                Property::encode_byte_property(packet, PropertyIdentifier::SubscriptionIdentifierAvailable, data)
            },
            Property::SharedSubscriptionAvailable(data) => {
                Property::encode_byte_property(packet, PropertyIdentifier::SharedSubscriptionAvailable, data)
            },
        }
    }

    fn encode_string_property<'b>(packet: &mut ReversedPacketWriter<'b>, id: PropertyIdentifier, text: &'a str) -> Result<(), Error>
    {
    ...
    fn encode_byte_property<'b>(packet: &mut ReversedPacketWriter<'b>, id: PropertyIdentifier, byte:
            &u8) -> Result<(), Error>
    {
        packet.write(&[*byte])?;
        packet.write_variable_length_integer(id as usize)?;
    ...
    fn encode_variable_length_integer_property<'b>(packet: &mut ReversedPacketWriter<'b>, id: PropertyIdentifier, value: &usize) -> Result<(), Error>
    {
    ...
    fn encode_four_byte_integer_property<'b>(packet: &mut ReversedPacketWriter<'b>, id:
            PropertyIdentifier, value: &u32) -> Result<(), Error>
    {
    ...
    fn encode_binary_data_property<'b>(packet: &mut ReversedPacketWriter<'b>, id: PropertyIdentifier, data: &[u8]) -> Result<(), Error>
    {
    ...
    fn encode_two_byte_integer_property<'b>(packet: &mut ReversedPacketWriter<'b>, id:
            PropertyIdentifier, value: &u16) -> Result<(), Error>
    {
    ...
    fn encode_string_pair_property<'b>(packet: &mut ReversedPacketWriter<'b>, id: PropertyIdentifier, key: &'a str, value: &'a str) -> Result<(), Error>
    {
